...
public class TestCase1 {
	...
	public void RegisterUser() throws InterruptedException {
		...
		// Varify that homepage is visible succesfully
		...
		// Varify that 'New User Signup!' is visible 
		assertEquals(driver.findElement(By.cssSelector("div.signup-form h2")).isDisplayed(), true);
		assertEquals(driver.findElement(By.cssSelector("div.signup-form h2")).getText(), "New User Signup!");
